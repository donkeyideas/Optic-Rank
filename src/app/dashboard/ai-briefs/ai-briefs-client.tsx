...
export function AIBriefsClient({
  ...
  const headlineStats = [
    ...
    },
    {
      label: "Latest",
      value: briefs[0]
        ? new Date(briefs[0].created_at).toLocaleDateString("en-US", {
            month: "short",
            day: "numeric",
          })
        : "None",
          ...
          {selectedBrief ? (
            <article className="flex flex-col gap-6">
              ...
              <div className="border-b-2 border-ink pb-4">
                <div className="mb-2 flex items-center gap-2">
                  ...
                  <span className="font-mono text-[10px] text-ink-muted">
                    {new Date(selectedBrief.created_at).toLocaleDateString("en-US", {
                      weekday: "long",
                      year: "numeric",
                      month: "long",
                      day: "numeric",
              ...
              <div className="flex items-center gap-2 border-t border-rule pt-4 text-[10px] text-ink-muted">
                ...
                {new Date(selectedBrief.created_at).toLocaleTimeString()}
              </div>
            </article>
          ) : (

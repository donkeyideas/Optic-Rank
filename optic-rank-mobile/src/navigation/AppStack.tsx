...
const DRAWER_SECTIONS: DrawerSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { screen: "Optimization", label: "SEO & Analytics", icon: "sliders" },
    ],
  },
  {
    title: "OPTIC RANK",
    items: [
      ...
      { screen: "Recommendations", label: "Recommendations", icon: "award" },
    ...
    <View style={[drawerStyles.container, { backgroundColor: colors.surface }]}>
      ...
      <ScrollView style={drawerStyles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.7}
        >
          <Feather name={isDark ? "sun" : "moon"} size={16} color={colors.inkMuted} />
...
export default function AppStack() {
  ...
  return (
    ...
    >
      ...
      <Drawer.Screen name="CreateProject" component={CreateProjectScreen} options={{ headerShown: false, drawerItemStyle: { display: "none" } }} />

      {/* SEO Tools */}
      <Drawer.Screen name="Keywords" component={KeywordsScreen} options={{ title: "Keyword Intelligence" }} />
      <Drawer.Screen name="Compete" component={CompetitorsScreen} options={{ title: "Competitive Intelligence" }} />
      <Drawer.Screen name="Backlinks" component={BacklinksScreen} options={{ title: "Backlink Intelligence" }} />
      <Drawer.Screen name="SiteAudit" component={SiteAuditScreen} options={{ title: "Site Audit" }} />
      <Drawer.Screen name="Content" component={ContentScreen} options={{ title: "Content Management" }} />
      <Drawer.Screen name="Optimization" component={OptimizationScreen} options={{ title: "SEO & Growth Analytics" }} />
      ...
      <Drawer.Screen name="Predictions" component={PredictionsScreen} options={{ title: "Predictive SEO Engine" }} />
      <Drawer.Screen name="AIBriefs" component={AIBriefsScreen} options={{ title: "Intelligence Briefs" }} />
      <Drawer.Screen name="Recommendations" component={RecommendationsScreen} options={{ title: "Recommendations" }} />
      ...
      <Drawer.Screen name="Entities" component={EntitiesScreen} options={{ title: "Entity SEO" }} />

      {/* Channels */}
      <Drawer.Screen name="AppStore" component={AppStoreScreen} options={{ title: "App Store Optimization" }} />

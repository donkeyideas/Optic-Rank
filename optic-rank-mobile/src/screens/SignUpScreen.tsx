...
export default function SignUpScreen() {
  ...
  const handleSignUp = async () => {
    ...
    setIsLoading(true);
    try {
      await signUp(email.trim(), password, fullName, company.trim());
    } catch (error: any) {
      Alert.alert(
        "Sign Up Failed",
  ...
  const handleOAuth = async (provider: "google" | "github") => {
    try {
      ...
      Alert.alert(
        "OAuth Error",
        error?.message || "Could not sign up with " + provider + "."
      );
    }
  };
    ...
    >
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={[styles.headerTagline, { color: colors.inkMuted }]}>

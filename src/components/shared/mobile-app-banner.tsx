          ...
          <div className="flex shrink-0 items-center gap-2">
            {appStoreUrl && (
              <a
                ...
                className="inline-flex h-8 items-center gap-1.5 bg-editorial-red px-3 text-[10px] font-bold uppercase tracking-widest text-white transition-colors hover:bg-editorial-red/85"
              >
